...
![](images/ShiftLeft.png)<!-- .element: style="float: center; width: 80%" -->
...
![](images/Reuse.png)<!-- .element: style="float: center; width: 80%" -->
...
![](images/Automation.png)<!-- .element: style="float: center; width: 80%" -->
...
![](images/Continuous_Integration.png)<!-- .element: style="float: center; width: 80%" -->
